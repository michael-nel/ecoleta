...
const CreatePoint = () => {
    ...
    function handleSelectItem(id: number) {
        const alreadySelect = selecetedItems.findIndex(item => item === id);
    ...
    return (
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                <h1>Cadas do <br /> ponto de coleta</h1>
                <fieldset>
                    <legend>
                        <h2>Dados</h2>
                    </legend>
                    <div className="field">
                        ...
                        <input type="text" name="text" id="name" onChange={handleInputChange} />
                    </div>
                ...
                <fieldset>
                    <legend>
                        <h2>Endereços</h2>
                        <span>Selecione o endereço dno mapa </span>
                    </legend>
